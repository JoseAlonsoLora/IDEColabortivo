...
public class CuentaJpaController implements Serializable {
    ...
    public void create(Cuenta cuenta) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            Programador idUsuario = cuenta.getIdUsuario();
            if (idUsuario != null) {
            ...
            em.persist(cuenta);
            if (idUsuario != null) {
                idUsuario.getCuentaCollection().add(cuenta);
    ...
    public void edit(Cuenta cuenta) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Cuenta persistentCuenta = em.find(Cuenta.class, cuenta.getNombreUsuario());
            Programador idUsuarioOld = persistentCuenta.getIdUsuario();
            Programador idUsuarioNew = cuenta.getIdUsuario();
            ...
            if (idUsuarioOld != null && !idUsuarioOld.equals(idUsuarioNew)) {
                idUsuarioOld.getCuentaCollection().remove(cuenta);
                idUsuarioOld = em.merge(idUsuarioOld);
            }
            if (idUsuarioNew != null && !idUsuarioNew.equals(idUsuarioOld)) {
                idUsuarioNew.getCuentaCollection().add(cuenta);
    ...
    public void destroy(String id) throws NonexistentEntityException {
        ...
        try {
            ...
            Programador idUsuario = cuenta.getIdUsuario();
            if (idUsuario != null) {
                idUsuario.getCuentaCollection().remove(cuenta);
                idUsuario = em.merge(idUsuario);
            }
            em.remove(cuenta);
            em.getTransaction().commit();
